...
const SUPABASE_URL  = "https://ouxnnvlfdbxyodllgko.supabase.co";   // ← paste here
  ...
  const AdminPage = () => {
    ...
    return (
      <div style={{ maxWidth:1200, margin:"0 auto", padding:"36px 20px" }}>
        ...
        {adminTab==="announcements" && <AnnouncementsPanel S={S} textMain={textMain} textSub={textSub} border={border} bg1={bg1} DM={DM} toast$={toast$}/>}
      </div>
    );
  };
